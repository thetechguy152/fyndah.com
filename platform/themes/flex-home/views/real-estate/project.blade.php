...
<main class="detailproject">
    ...
    <div class="container-fluid w90 padtop30 single-post">
        <section class="general">
            ...
            <property-component type="project-properties-for-sell" title="{{ __('Properties For Sale') }}" :project_id="{{ $project->id }}" url="{{ route('public.ajax.properties') }}"></property-component>

            <property-component type="project-properties-for-rent" title="{{ __('Properties For Rent') }}" :project_id="{{ $project->id }}" url="{{ route('public.ajax.properties') }}"></property-component>
        </section>
