@php
$smartAds = GlobalFunctions::second_global_function();
@endphp 
<div>
<div>
    <!-- Cards -->
    <div>
        ...
        <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4 rounded">
            <div class="p-5 bg-white dark:bg-gray-600 dark:text-gray-100 rounded border border-gray-600">
                ...
                <div class="text-lg mt-2 text-purple-700 font-semibold dark:text-white">{{$clicksToday}}</div>
            </div> 
            <div class="p-5 bg-white dark:bg-gray-600 dark:text-gray-100 rounded border border-gray-600">
                <div class="text-sm">Yesterday</div>
                <div class="text-lg mt-2 text-purple-700 font-semibold dark:text-white">{{$clicksYesterday}}</div>
            </div> 
            <div class="p-5 bg-white dark:bg-gray-600 dark:text-gray-100 rounded border border-gray-600">
                <div class="text-sm">Last 7 days</div>
                <div class="text-lg mt-2 text-purple-700 font-semibold dark:text-white">{{$clicks7Days}}</div>
            </div>
            <div class="p-5 bg-white dark:bg-gray-600 dark:text-gray-100 rounded border border-gray-600">
                <div class="text-sm">This month</div>
                <div class="text-lg mt-2 text-purple-700 font-semibold dark:text-white">{{$clicksThisMonth}}</div>
            </div>   
        </div>
    </div>
    <div>
        <div class="mb-3 ml-1 dark:text-purple-800 font-semibold text-lg">Views Summary</div>
        <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4 rounded">
            <div class="p-5 bg-white dark:bg-gray-600 dark:text-gray-100 rounded border border-gray-600">
                <div class="text-sm">Today so far</div>
                <div class="text-lg mt-2 text-purple-700 font-semibold dark:text-white">{{$viewsToday}}</div>
            </div> 
            <div class="p-5 bg-white dark:bg-gray-600 dark:text-gray-100 rounded border border-gray-600">
                <div class="text-sm">Yesterday</div>
                <div class="text-lg mt-2 text-purple-700 font-semibold dark:text-white">{{$viewsYesterday}}</div>
            </div> 
            <div class="p-5 bg-white dark:bg-gray-600 dark:text-gray-100 rounded border border-gray-600">
                <div class="text-sm">Last 7 days</div>
                <div class="text-lg mt-2 text-purple-700 font-semibold dark:text-white">{{$views7Days}}</div>
            </div>
            <div class="p-5 bg-white dark:bg-gray-600 dark:text-gray-100 rounded border border-gray-600">
                <div class="text-sm">This month</div>
                <div class="text-lg mt-2 text-purple-700 font-semibold dark:text-white">{{$viewsThisMonth}}</div>
            </div>   
        </div>
    </div>
    ...
    <div class="mt-5 bg-gray-100 rounded p-3 border border-gray-200">
        ...
        <div class="mt-7">
            <div class="px-4 sm:px-6 lg:px-8">
                <div class="sm:flex sm:items-center">
                    <div class="sm:flex-auto">
                        <h1 class="text-xl font-semibold text-gray-900">Ad Views</h1>
                        <p class="mt-2 text-sm text-gray-700">List of Ads with views count for the selected period.</p>
                    </div>
                </div>
                <div class="mt-8 flex flex-col">
                    <div class="-my-2 -mx-4 overflow-x-auto sm:-mx-6 lg:-mx-8">
                    <div class="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
                        ...
                        <table class="min-w-full divide-y divide-gray-300">
                            ...
                            <tbody class="divide-y divide-gray-200 bg-white">
                                @foreach($smartAds as $ad)
                                    <tr>
                                        <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-6">{{$ad->name}}</td>
                                        <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-6">{{$ad->views}}</td>
                                    </tr>
                                @endforeach
                            </tr>
                            <!-- More people... -->
